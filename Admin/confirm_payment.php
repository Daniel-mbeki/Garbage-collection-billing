    ...
    <div class="bg-light">
        <div class="container">
            <div class="row justify justify-content-center">
                <div class="col-12 col-md-12 col-lg-12 col-xl-15">
                    <form class="" method="POST" action="confirm_payment.php">
                        <div class="card bg-dark">
                                ...
                                <div class="col-md-12">
                                    ...
                                    if (isset($_POST['submit'])) {
                                        ...
                                        $data = array(
                                            "mobile" => $_POST['phone'],
                                            "response_type" => "json",
                                            "sender_name" => "Enter uar  personal sender id",
                                            "service_id" => 0,
                                            "message" => $_POST['message'],
                                        );
                                        $payload = json_encode($data);
                                        curl_setopt($ch, CURLOPT_POSTFIELDS, $payload);
                                        curl_setopt($ch, CURLOPT_HTTPHEADER, array('Content-Type:application/json', 'h_api_key:Personal key'));
                            ...
                            <div class="form-group row mb-3">
                                <div class="col-md-12 mb-0">
                                    <p class="mb-1">Phone</p> <input id="e-mail" type="text" placeholder="Enter clients phone" name="phone" class="form-control input-box rm-border">
                                </div>
                            </div>
